...
<form action="{{route('comics.store')}}" method="POST">
        ...
        <div class="container mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" id="price"  name="price" value="{{old('title')}}" required>
            @error('type')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <select class="form-control @error('title') is-invalid @enderror" id="type"  name="type" value="{{old('title')}}" required>
